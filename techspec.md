...
Build a **complete, production-ready portfolio website** using **Figma DevMode MCP**, **Context7 MCP**, and **Playwright MCP** with modern responsive design, accessibility, and performance optimization.
...
- **Dynamic Viewport Units**: Use `vw`, `vh`, `dvh` for fluid scaling
- **Breakpoint Strategy**:
    - Mobile: 320px-767px (single column)
    - Tablet: 768px-1023px (2-column grids)
    - Desktop: 1024px+ (multi-column layouts)
    - Ultra-wide: 1920px+ (optimized scaling)
- **Typography Scaling**: Fluid typography using `clamp()` or `vw` units
...
- **Headings**: Scale from 6vw (mobile) to 2vw (desktop)
- **Body text**: Scale from 3.5vw (mobile) to 1.1vw (desktop)
